...
GLfloat	g_fCnt1						= 0.0f;								// 1st Counter Used To Move Text & For Coloring
GLfloat	g_fCnt2						= 0.0f;								// 2nd Counter Used To Move Text & For Coloring
...
GLvoid BuildFont(GLvoid)
{
	...
	hFont = CreateFont(-24,								// Height of font
		...
		0,												// Orientation Angle
		FW_BOLD,										// Font weight: FW_DONTCARE is 0, FW_NORMAL is 400, FW_BOLD is 700 and FW_BLACK is 900
		FALSE,											// Italic
		FALSE,											// Underline
		FALSE,											// Strikeout
